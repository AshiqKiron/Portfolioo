 ...
 */
 ...
 upsell = jQuery('<a class="portfolioo-upsell-link"></a>')
...
// Remove accordion click event
 jQuery('.portfolioo-upsell-link').on('click', function(e) {
	 e.stopPropagation();
	});
 }
...
/*if (document.location.href.indexOf('page-template-landing-page-php') > -1){ 
    //Your code goes here
}*/
