...
?>
		...
		<!-- 	<div class="col-md-7">
			...
			<div class="row">
					...
					<ul>
						...
						<li><?php esc_html_e('Check out the', 'portfolioo'); ?> <a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/portfolioo#demos'); ?>"><?php esc_html_e('Portfolioo Demos', 'portfolioo'); ?></a></li>
					</ul>
			...
			<div class="col-md-12 text-block no-bottom-margin">
				<div class="row">
					...
					<span  class="dashboard-upgrade-button"><a target="_blank" href="https://asphaltthemes.com/portfolioo#buy_pro" target="_blank"><?php esc_html_e( 'Upgrade', 'portfolioo' ); ?></a></span>
			...
			<div class="row flexify--center">
				...
				<div class="col-md-5 dashboard-cta-right">
					<a target="_blank" class="theme__cta--download--pro" href="<?php echo esc_url('https://asphaltthemes.com/portfolioo#buy_pro'); ?>"><?php esc_html_e( 'Upgrade Now', 'portfolioo' ); ?></a>
		...
		<div class="dashboard__blocks">
			<div class="col-md-4">
				...
				<ol>
					<li><?php esc_html_e( 'Portfolioo', 'portfolioo' ); ?> <a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/portfolioo-pro/how-to-setup-front-page/'); ?>"><?php esc_html_e( 'Documentation', 'portfolioo' ); ?></a></li>
					...
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/contact/'); ?>"><?php esc_html_e( 'Email Support', 'portfolioo' ); ?></a></li>
				</ol>
			</div>
			...
			<div class="col-md-4">
				...
				<ol>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/portfolioo-pro/how-to-setup-front-page/'); ?>"><?php esc_html_e( 'How To Set up the Front Page', 'portfolioo' ); ?></a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/portfolioo-pro/upgrading-to-portfolioo-pro/'); ?>"><?php esc_html_e( 'Upgrading To portfolioo Pro', 'portfolioo' ); ?></a></li>
					<li><a target="_blank" href="<?php echo esc_url('https://asphaltthemes.com/docs/portfolioo-pro/basic-site-settings/'); ?>"><?php esc_html_e( 'Basic Site Settings', 'portfolioo' ); ?></a></li>
				</ol>
			</div>
		</div>
