...
function portfolioo_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'footer_section' , array(
		    'title'      => esc_html__('Footer settings','portfolioo'), 
		    'panel'      => 'footer',
		    'capability'     => 'edit_theme_options',
		    'priority'   => 10   
		)
	...
	$wp_customize->add_setting('portfolioo[colophon_txt_color]',array(
				...
				$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'colophon_txt_color', array(
				               ...
				               'settings'   => 'portfolioo[colophon_txt_color]' 
				           )
				       )
				   );
	...
	// colophon icon color
	$wp_customize->add_setting('portfolioo[colophon_icon_color]',array(
		          'default'         => 'yellow',
		          'sanitize_callback' => 'sanitize_hex_color',
		          'transport'       => 'postMessage',
		          'type'            => 'option',
				...
				// Control
				$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize,'colophon_icon_color', array(
				               'label'      => esc_html__( 'Icon Color', 'portfolioo' ),
				               'section'    => 'footer_section',
				               'settings'   => 'portfolioo[colophon_icon_color]' 
				           )
				       )
				   );
	...
	// colophon bg Color
	$wp_customize->add_setting('portfolioo[footer_bg_color]',array(
		          'default'         => '#0c051a',
		          'sanitize_callback' => 'sanitize_hex_color',
		          'transport'       => 'postMessage',
		          'type'            => 'option',
